...
const ::substrait::Expression_Literal& toSubstraitNotNullLiteral(
  ...
  switch (variantValue.kind()) {
    ...
    default:
      BOLT_NYI("Unsupported constant Type '{}' ", mapTypeKindToName(variantValue.kind()));
  }
...
const ::substrait::Expression_Literal& toSubstraitNotNullLiteral(
  ...
  BOLT_UNSUPPORTED("toSubstraitNotNullLiteral function doesn't support {} type", TypeTraits<kind>::name);
...
const ::substrait::Expression_Cast& BoltToSubstraitExprConvertor::toSubstraitExpr(
    google::protobuf::Arena& arena,
...
const ::substrait::Expression_FieldReference& BoltToSubstraitExprConvertor::toSubstraitExpr(
    google::protobuf::Arena& arena,
...
const ::substrait::Expression_FieldReference& BoltToSubstraitExprConvertor::toSubstraitExpr(
  ...
  BOLT_USER_CHECK(input.has_selection(), "Non-field expression is not supported");
...
const ::substrait::Expression_Literal_List& BoltToSubstraitExprConvertor::toSubstraitLiteralList(
    google::protobuf::Arena& arena,
    const ArrayVector* arrayVector,
    vector_size_t row) {
  ::substrait::Expression_Literal_List* listLiteral =
  ...
  BOLT_NYI("Complex type literals are not supported: {}", arrayVector->elements()->type()->toString());
}

const ::substrait::Expression_Literal& BoltToSubstraitExprConvertor::toSubstraitLiteralComplex(
    google::protobuf::Arena& arena,
  ...
  BOLT_NYI("Complex type literals are not supported: {}", constantVector->type()->toString());
}
...
const ::substrait::Type_List& BoltToSubstraitExprConvertor::toSubstraitLiteralEmptyList(
    google::protobuf::Arena& arena,
