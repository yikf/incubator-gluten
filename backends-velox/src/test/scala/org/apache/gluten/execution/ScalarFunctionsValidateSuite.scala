...
abstract class ScalarFunctionsValidateSuite extends FunctionsValidateSuite {
  ...
  testAtLeastSparkVersion("Test array_append function - INT", "3.4") {
    withTempPath {
      path =>
        Seq[(Array[Int], Int)](
          (Array(2, 1), 0),
  ...
  testAtLeastSparkVersion("null input for array_size", "3.3") {
    withTempPath {
      path =>
        Seq[(Array[Int])](
  ...
  testAtLeastSparkVersion("Test width_bucket function", "3.4") {
    withTempPath {
      path =>
  ...
  testAtLeastSparkVersion("Test url_decode function", "3.4") {
    withTempPath {
      path =>
  ...
  testAtLeastSparkVersion("Test url_encode function", "3.4") {
    withTempPath {
      path =>
  ...
  testAtLeastSparkVersion("mask", "3.4") {
  ...
  testAtLeastSparkVersion("try_subtract", "3.3") {
    runQueryAndCompare(
  ...
  testAtLeastSparkVersion("try_multiply", "3.3") {
    runQueryAndCompare(
  ...
  testAtLeastSparkVersion("get", "3.4") {
    withTempPath {
      path =>
        Seq[Seq[Integer]](Seq(1, null, 5, 4), Seq(5, -1, 8, 9, -7, 2), Seq.empty, null)
          .toDF("value")
  ...
  testAtLeastSparkVersion("levenshtein with limit", "3.5") {
  ...
  testAtLeastSparkVersion("array insert", "3.4") {
    withTempPath {
      path =>
        Seq[Seq[Integer]](Seq(1, null, 5, 4), Seq(5, -1, 8, 9, -7, 2), Seq.empty, null)
          .toDF("value")
  ...
  testAtLeastSparkVersion("Test try_cast", "3.4") {
