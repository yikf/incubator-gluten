...
class JsonFunctionsValidateSuite extends FunctionsValidateSuite {
  ...
  testAtLeastSparkVersion("from_json function bool", "3.4") {
    withTempPath {
      path =>
        Seq[(String)](
          ("""{"id":0}"""),
  ...
  testAtLeastSparkVersion("from_json function small int", "3.4") {
    withTempPath {
      path =>
        Seq[(String)](
          ("""{"id":100000000}"""),
  ...
  testAtLeastSparkVersion("from_json function int", "3.4") {
    withTempPath {
      path =>
        Seq[(String)](
          ("""{"id":10}"""),
  ...
  testAtLeastSparkVersion("from_json function big int", "3.4") {
    withTempPath {
      path =>
        Seq[(String)](
          ("""{"id":100000000}"""),
  ...
  testAtLeastSparkVersion("from_json function float", "3.4") {
    withTempPath {
      path =>
        Seq[(String)](
          ("""{"id":10}"""),
  ...
  testAtLeastSparkVersion("from_json function double", "3.4") {
    withTempPath {
      path =>
        Seq[(String)](
          ("""{"id":10}"""),
  ...
  testAtLeastSparkVersion("from_json function string", "3.4") {
    withTempPath {
      path =>
        Seq[(String)](
          ("""{"id":10}"""),
  ...
  testAtLeastSparkVersion("from_json function array", "3.4") {
    withTempPath {
      path =>
        Seq[(String)](
          ("""[]"""),
  ...
  testAtLeastSparkVersion("from_json function map", "3.4") {
    withTempPath {
      path =>
        Seq[(String)](
          ("""{"id":10, "value":11}"""),
  ...
  testAtLeastSparkVersion("from_json function row", "3.4") {
    withTempPath {
      path =>
        Seq[(String)](
          ("""{"Id":"10", "Value":"11"}"""),
  ...
  testAtLeastSparkVersion("from_json function duplicate key", "3.4") {
    withTempPath {
      path =>
        Seq[(String)](
          ("""{"id":1,"Id":2}"""),
