...
abstract class VeloxAggregateFunctionsSuite extends VeloxWholeStageTransformerSuite {
  ...
  testAtLeastSparkVersion("regr_r2", "3.3") {
    runQueryAndCompare("""
  ...
  testAtLeastSparkVersion("regr_slope", "3.4") {
    runQueryAndCompare("""
  ...
  testAtLeastSparkVersion("regr_intercept", "3.4") {
    runQueryAndCompare("""
  ...
  testAtLeastSparkVersion("regr_sxy regr_sxx regr_syy", "3.4") {
    runQueryAndCompare("""
