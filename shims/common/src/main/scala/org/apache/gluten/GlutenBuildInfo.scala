...
object GlutenBuildInfo {
  ...
  val BOLT_BRANCH: String = props.getProperty("bolt_branch", unknown)
  val BOLT_REVISION: String = props.getProperty("bolt_revision", unknown)
  val BOLT_REVISION_TIME: String = props.getProperty("bolt_revision_time", unknown)
